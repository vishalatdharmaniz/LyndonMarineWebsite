...
<section id="work-done">
  ...
  <div class="input-group-btn"> <a class="btn btn-default text-muted" href="#" title="Clear" onclick="reset()"><i class="glyphicon glyphicon-remove"></i> </a>
    ...
    <div class="col-md-4">
    <div class="input-group">   
  <form id="drop_down"  action="<?php echo base_url().'index.php/VesselSurvey/search_dropdown' ?>" method="get">
            ...
            <tr>
              ...
              <td><?php
							if($value['range_from'] != "0000-00-00 00:00:00"){
							 ...
							 ?></td>
              <td><?php echo $res; ?></td>
              <td><a href="<?php echo base_url();?>index.php/VesselSurvey/edit/<?php echo $value['id']; ?>" class="btn-bk"> <i class="fa fa-pencil" aria-hidden="true"></i></a> <a href="<?php echo base_url();?>index.php/VesselSurvey/delete/<?php echo $value['id']; ?>" Onclick="return confirm('Are you Sure?');" class="btn-bk"> <i class="fa fa-trash" aria-hidden="true"></i></a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
