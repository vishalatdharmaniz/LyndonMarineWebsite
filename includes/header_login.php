...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" style="margin-top:7px" href="<?php echo base_url();?>index.php/AllVessels/user_vessel/<?php $user_id = $this->session->userdata('user_id');echo $user_id; ?>"><img src="<?php echo base_url(); ?>img/logo@1x.png" ></a> </div>
   		 <ul class="nav navbar-nav navbar-right">
                
                
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="margin-top:20px"><?php $user_id = $this->session->userdata('email'); echo $user_id;?><b class="caret"></b></a>
