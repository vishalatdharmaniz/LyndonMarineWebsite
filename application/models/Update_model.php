...
class Update_model extends CI_Model
{
	...
	{
              $this->db->query("UPDATE recommendation SET recommendation_type='$recommendation_type'                    ,recommendation_date='$recommendation_date',due_date='$due_date',
              	                      description='$description',rectified_status='$rectified_status',
