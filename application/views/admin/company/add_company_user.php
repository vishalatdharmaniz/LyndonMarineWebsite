          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_content">
										...
										<?php echo validation_errors(); ?>
											...
											<?php
											$url = base_url()."index.php/admin/company/add_company_user/".$company_id;
											?>
                    ...
                    <!--<form method="post" action="<?php //echo base_url();?>index.php/admin/company/add_company_user/<?php //echo $company_id; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first_name" name="fname" required  value="<?php echo set_value('fname'); ?>" class="form-control col-md-7 col-xs-12" placeholder="First Name">
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('last_name'); ?>" required type="text" name="last_name" placeholder="Last Name">
                        </div>
                           </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="job"  value="<?php echo set_value('job'); ?>" class="form-control col-md-7 col-xs-12"placeholder="Job Description">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('username'); ?>" required type="text" name="username" placeholder="Username">
                        </div>
                           </div>                         
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" required type="text" name="email" value="<?php echo set_value('email'); ?>" placeholder="Email Address">
                        </div>
                           </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12" required name="role">
															<option value="" <?php if(set_value('role')==""){ echo "selected=selected";} ?> >Choose option</option>
