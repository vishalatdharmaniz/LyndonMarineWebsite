...
<section id="work-done">
  <div class="container"> <div class="row">
     ...
     <div class="col-md-2">
      <!-- to align status dropdown to right. -->
     </div>
   <div class="col-md-2">
       <div class="input-group">
        <?php
...
function mail_selected_vessels()
{
    ...
    var checkbox_ids = ''; or all email document 
...
$('#suppliers').change(function(){
      $selected_value=$('#suppliers option:selected').text();
        var $vessel_id = '<?php echo $vessel_id; ?>'; 
      window.location.href = "<?php echo base_url(); ?>index.php/VesselBunkerSupply/search_supplier_type/"+$selected_value+"/"+$vessel_id;
    });
