  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <br><div class="main-edit-add"> <a class="btn-blue" href="<?php echo base_url(); ?>index.php/VesselCertificate/index/<?php echo $vessel_id; ?>">All Certificate</a> </div>
  ...
  <div class="container">
    <!--<div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <a><button type="button" id="yellow" class="update text-center btn btn-yelow btn-sm"></button></a>&nbsp;<span>Due in 45 days</span>&nbsp;&nbsp;
      ...
      <?php foreach($certificate_data as $data) { ?>
              <tr>
                ...
                ?>
                  ...
                  ?>
                  <button type="button" id="browncolor" class="update text-center btn btn-brwon btn-sm"></button><span id="text"></span>
                  <?php } 
                  elseif($calday<=0) {
                  ?>
                 ...
                 <td>
                  <input type="checkbox" id="<?php echo $data['certificate_id']; ?>">
                </td>
