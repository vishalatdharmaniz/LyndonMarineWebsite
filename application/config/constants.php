...
{
    define('BASE_URL', 'http://localhost/LyndonMarineWebsite');
}
elseif(ENVIRONMENT == 'production')
{
    define('BASE_URL', 'http://dharmani.com/LyndonMarineWebsite');
}
else
{
    define('BASE_URL', 'http://staging.lyndonmarine.com');
}

/* Profile Images Base Url */

if (ENVIRONMENT == 'development')
{
    define('PROFILE_IMAGES_BASE_URL', 'http://localhost/LyndonMarineImages/ProfileImages/');
}
elseif(ENVIRONMENT == 'production')
{
...
if (ENVIRONMENT == 'development')
{
    define('VESSEL_IMAGES_BASE_URL', 'http://localhost/LyndonMarineImages/LyndonMarineVessels/');
}
elseif(ENVIRONMENT == 'production')
{
    define('VESSEL_IMAGES_BASE_URL', 'http://dharmani.com/LyndonMarineImages/LyndonMarineVessels/');
}
else
{
    define('VESSEL_IMAGES_BASE_URL', 'http://root.lyndonmarine.com/LyndonMarineImages/LyndonMarineVessels/');
}
...
if (ENVIRONMENT == 'development')
{
    define('DOCUMENT_BASE_URL', 'http://localhost/LyndonMarineImages/LyndonMarineVessels/');
}
elseif(ENVIRONMENT == 'production')
{
    define('DOCUMENT_BASE_URL', 'http://dharmani.com/LyndonMarineImages/LyndonMarineVessels/');
}
else
{
...
if (ENVIRONMENT == 'development')
{
    define('BUNKER_SUPPLY_BASE_URL', 'http://localhost/LyndonMarineImages/BunkerSupplyDocuments');
}
elseif(ENVIRONMENT == 'production')
{
    define('BUNKER_SUPPLY_BASE_URL', 'http://dharmani.com/LyndonMarineImages/BunkerSupplyDocuments');
}
else
{
...
{
    define('TARGET_DIR', $_SERVER['DOCUMENT_ROOT'].'/LyndonMarineImages/');
}
