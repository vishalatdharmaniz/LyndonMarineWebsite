...
class Vessel_certificate extends CI_Controller
{
    ...
    public function index($vessel_id,$offset=0)
    {
       ...
       $certificate_data = $this->Certificate_model->get_all_certificate_data_for_pagination($vessel_id,$offset);
     
       $total_certificate = $this->Certificate_model->get_total_certificate($vessel_id);
            
       $config['base_url'] = base_url().'index.php/Vessel_certificate/index/'.$vessel_id;
    ...
    public function searchdata($searchname,$vessel_id,$offset=0)
    {
        ...
        $total_search_certificate = $this->Certificate_model->searchtable_total($searchname,$vessel_id);
            ...
            $config['base_url'] = base_url().'index.php/Vessel_certificate/searchdata/'.$searchname.'/'.$vessel_id;
	...
	public function search_certificate_type($searchtype,$vessel_id)
    {
       ...
       {*/
        ...
        $config['base_url'] = base_url().'index.php/Vessel_certificate/search_certificate_type/'.$searchtype.'/'.$vessel_id;
        $config['total_rows'] = $total_search_certificate;
        $config['per_page'] = 10;
        $config['uri_segment'] = 5;
    ...
    public function search_dropdown_status($vessel_id){
        ...
        $config["base_url"] = base_url() . "index.php/Vessel_certificate/search_dropdown_status/$vessel_id?range=$range";
        $config['per_page'] = '10';
            $config['num_links'] = '5';
            $config['full_tag_open'] = '<ul class="pagination">';
            $config['full_tag_close'] = '</ul>';
