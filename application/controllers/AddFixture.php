...
class AddFixture extends CI_Controller
 {
   ...
   public function add_fixture($vessel_id)
      {
		   $this->load->model('Fixture_model');
		   $this->load->model('Vessel_model');
			...
			//----------------- file upload code--------------------------
				...
				$abc=$this->Fixture_model->add($data); /*var_dump($data);die();*/
			...
			$base_url = BASE_URL;  
               $header=header("Location: $base_url/index.php/Vessel_fixture/index/$vessel_id");
               /* var_dump($header);*/die();
		}
}
